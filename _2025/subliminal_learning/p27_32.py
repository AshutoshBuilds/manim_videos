...
class P27_30(Scene):
    def construct(self):
        ...
        self.play(self.camera.frame.animate.move_to([3, 0, 0]),
                  FadeOut(top_dimension),
                  FadeOut(left_dimension),
                  FadeOut(model_parameters_text), run_time=2)
        ...
        self.play(self.camera.frame.animate.move_to([0, 0, 0]),
                  FadeOut(mnist_network),
                  FadeOut(p28_to_manim_4), run_time=2
                  )
        ...
        t_weight_eq = Tex(r"\theta_T = \theta_T^0 + \Delta \theta_T").move_to(t_model_parameters.get_center()).shift(DOWN * 2.75)
        ...
        s_weight_eq = Tex(r"\theta_S = \theta_S^0 + \Delta \theta_S").move_to(s_model_parameters.get_center()).shift(DOWN * 2.75)
        ...
        self.play(
            ReplacementTransform(t_model_parameters[3:28].copy(), VGroup(equal_weights[0], equal_weights[2])),
            ReplacementTransform(s_model_parameters[3:28].copy(), VGroup(equal_weights[4], equal_weights[6])),
            Write(equal_weights_text),
        ...
        self.play(
            ...
            Write(t_weight_text), run_time=1.5
        )
