...
class p65_68(InteractiveScene):
    ...
    def construct(self):
        ...
        self.play(FadeOut(bias_region_3), FadeOut(std_region_3), FadeOut(mean_fit_line_3), run_time=2)
        ...
        self.play(FadeOut(std_region_4), 
        ...
        self.play(FadeOut(selected_fifth_order_fits))
        self.wait()
