...
class P27_30(Scene):
    def construct(self):
        ...
        self.play(
            ReplacementTransform(t_model_parameters[0:2].copy(), VGroup(equal_weights[0], equal_weights[2])),
            ReplacementTransform(s_model_parameters[0:2].copy(), VGroup(equal_weights[4], equal_weights[6])),
            run_time=2
        )
