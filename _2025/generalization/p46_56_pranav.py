...
graphics_dir=os.path.expanduser('~/Downloads')
...
class p46_56(InteractiveScene):
    ...
    def construct(self):
        ...
        all_fits = np.load(os.path.join(graphics_dir, 'all_fits_oct_13_1.npy'))
        all_coeffs = np.load(os.path.join(graphics_dir, 'all_coefs_oct_13_1.npy'))
