...
def get_dem_numbers_3d(i, xs, weights, logits, yhats):
    ...
    w = weights[i, :]
    tm1_1 = Tex(format_number(w[0], total_chars=6)).set_color(BLUE)
    tm1_1.scale(0.12)
    tm1_1.rotate(90*DEGREES, [1, 0, 0])
    tm1_1.move_to([-1.04, 0, 0.85])
    nums.add(tm1_1)
    
    tm1_2 = Tex(format_number(w[1], total_chars=6)).set_color(BLUE)
    tm1_2.scale(0.12)
    tm1_2.rotate(90*DEGREES, [1, 0, 0])
    tm1_2.move_to([-1.04, 0, 0.72])
    nums.add(tm1_2)       

    tb1 = Tex(format_number(w[8], total_chars=6)).set_color(BLUE)
    tb1.scale(0.12).rotate(90*DEGREES, [1, 0, 0])
    tb1.move_to([-1.04,0,  0.59])
    nums.add(tb1)

    tm2_1 = Tex(format_number(w[2], total_chars=6)).set_color(RED)
    tm2_1.scale(0.12).rotate(90*DEGREES, [1, 0, 0])
    tm2_1.move_to([-1.04,0,  0.38])
    nums.add(tm2_1)
    
    tm2_2 = Tex(format_number(w[3], total_chars=6)).set_color(RED)
    tm2_2.scale(0.12).rotate(90*DEGREES, [1, 0, 0])
    tm2_2.move_to([-1.04,0,  0.25])
    nums.add(tm2_2)       

    tb2 = Tex(format_number(w[9], total_chars=6)).set_color(RED)
    ...
    tm4_1 = Tex(format_number(w[6], total_chars=6)).set_color(PURPLE)
    tm4_1.scale(0.12).rotate(90*DEGREES, [1, 0, 0])
    tm4_1.move_to([-1.04, 0, -0.54])
    nums.add(tm4_1)
    
    t4_2 = Tex(format_number(w[7], total_chars=6)).set_color(PURPLE)
    t4_2.scale(0.12).rotate(90*DEGREES, [1, 0, 0])
    t4_2.move_to([-1.04, 0, -0.68])
    nums.add(t4_2)       

    tb4 = Tex(format_number(w[11], total_chars=6)).set_color(PURPLE)
    ...
    # Logits
    tl1 = Tex(format_number(logits[i, 0], total_chars=6)).set_color(BLUE)
    tl1.scale(0.14).rotate(90*DEGREES, [1, 0, 0])
    tl1.move_to([-0.49, 0, 0.54])
    nums.add(tl1)
    
    tl2 = Tex(format_number(logits[i, 1], total_chars=6)).set_color(RED)
    ...
    tl4 = Tex(format_number(logits[i, 3], total_chars=6)).set_color(PURPLE)
    tl4.scale(0.14).rotate(90*DEGREES, [1, 0, 0])  
    tl4.move_to([-0.48, 0, -0.5])
    nums.add(tl4)

    #Predictions
    yhat1 = Tex(format_number(yhats[i, 0], total_chars=6)).set_color(BLUE)
    yhat1.scale(0.18).rotate(90*DEGREES, [1, 0, 0])
    yhat1.move_to([0.18, 0, 0.36])
    nums.add(yhat1)
    
    yhat2 = Tex(format_number(yhats[i, 1], total_chars=6)).set_color(RED)
    ...
    yhat4 = Tex(format_number(yhats[i, 3], total_chars=6)).set_color(PURPLE)
...
class p48_49_v2(InteractiveScene):
    def construct(self):
        ...
        '''
        data=np.load(data_path+'/cities_2d_book_1.npy')
        xs=data[:,:2]
        ys=data[:,2]
        weights=data[:,3:15]
        grads=data[:,15:27]
        ...
        europe_map=ImageMobject('/Users/stephen/Stephencwelch Dropbox/welch_labs/ai_book/3_backprop_2/graphics/LighModeBaarle5DotLarge.png')
        ...
        box=Rectangle(0.18, 0.05).set_color(BLUE)
        ...
        box2=Rectangle(0.11, 0.05).set_color(RED)
        ...
        # if ys[i]==0.0: training_point.set_color(BLUE)
        # elif ys[i]==1.0: training_point.set_color(RED)
        # elif ys[i]==2.0: training_point.set_color(GREEN)   
        # elif ys[i]==3.0: training_point.set_color(PURPLE)   
        ...
        heatmaps=None
        training_point=None
        for i in range(249, 250): #len(xs)): #Runs out of RAM! #len(xs)): #TO DO -> change starting time to 1, 495 to go fast - ok i think i fixed
            if i>0:
                self.remove(nums)
        ...
        # ap1.scale(4.5).move_to([0,0,3])



        # self.wait()
        vert_offset=2.5
        self.play(ap1.animate.scale(4.5).move_to([0,0,vert_offset]).set_opacity(0.4),
                    ap2.animate.scale(4.5).move_to([0,0,vert_offset]).set_opacity(0.4),
                    ap3.animate.scale(4.5).move_to([0,0,vert_offset]).set_opacity(0.4),
                    ap4.animate.scale(4.5).move_to([0,0,vert_offset]).set_opacity(0.4),
                    europe_map.animate.rotate(-90*DEGREES, [1,0,0]).move_to([-0.05,-0.05,vert_offset]),
        ...
        # self.frame.reorient(11, 51, 0, (-0.2, 0.52, 1.77), 2.75)
        # self.frame.reorient(3, 42, 0, (-0.07, 0.39, 1.76), 2.33)
        self.frame.reorient(3, 43, 0, (-0.06, 0.44, 1.8), 2.05)
        self.wait()
        ...
        # plane_1.set_opacity(0.0)
        # plane_2.set_opacity(0.0)
        # plane_3.set_opacity(0.0)
        # plane_4.set_opacity(0.0)
        ...
        # self.frame.reorient(37, 56, 0, (-0.03, -0.09, -0.04), 1.83)
        # # self.remove(axes_1, axes_2, axes_3, axes_4)
        # self.remove(axes_1, axes_2, axes_3, axes_4)
        # self.add(axes_1) #, axes_2, axes_3, axes_4)
        # axes_1.set_opacity(1.0)
        # self.wait()


        # self.remove(europe_map, plane_1, plane_2, plane_3, plane_4)
        # # self.add(europe_map)
        ...
        # # self.remove(europe_map); self.add(europe_map)
        # self.remove(axes_1); self.add(axes_1)
        # # europe_map.set_opacity(0.8)
        ...
        # self.remove(plane_1); self.add(plane_1)
        ...
        # self.frame.reorient(-25, 56, 0, (0.03, -0.07, -0.08), 1.83)
