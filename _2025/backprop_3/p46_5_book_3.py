...
class p47m(InteractiveScene):
    def construct(self):
        ...
        #Book pause. 
        self.frame.reorient(0, 59, 0, (4.47, 0.45, -0.17), 8.13)
        self.wait(5)
        ...
        self.clear()
        self.frame.reorient(0, 50, 0, (4.32, -0.02, -0.75), 8.18)
        self.add(flat_map_2)
        self.add(top_polygons_vgroup_flat)
        self.add(lines_flat)
...
class p52b(InteractiveScene):
    def construct(self):
        ...
        #Book
        #Let's draw joint lines in illusrtraots
        self.remove(group_11[1], group_12[0], group_12[0], group_13[0])
        self.frame.reorient(0, 56, 0, (2.96, 1.01, 0.78), 7.02)
        self.wait(5)
        ...
        self.frame.reorient(0, 0, 0, (2.97, 0.01, 0.0), 2.06)
        self.wait() 
