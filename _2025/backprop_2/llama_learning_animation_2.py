...
class LlamaLearningSketchOne(InteractiveScene):
    def construct(self):
        ...
        neuron_fills=[
            snapshot['blocks.'+str(layer_num)+'.hook_resid_mid'],
        ...
        neuron_fills=[
            snapshot['blocks.'+str(layer_num+1)+'.hook_resid_mid'],
            snapshot['blocks.'+str(layer_num+1)+'.mlp.hook_post'],
            snapshot['blocks.'+str(layer_num+1)+'.hook_mlp_out']
        ]


        w1=snapshot['blocks.'+str(layer_num+1)+'.mlp.W_in']
        w2=snapshot['blocks.'+str(layer_num+1)+'.mlp.W_out']
