...
class P27(Scene):
    def construct(self):
        ...
        left_dimension = (
            VGroup(p27_to_manim_3[0], p27_to_manim_3[1], p27_to_manim_3[2])
            .scale(4)
            .next_to(VGroup(n1_1, n1_2), LEFT)
        )
        top_dimension = (
            VGroup(p27_to_manim_3[3], p27_to_manim_3[4], p27_to_manim_3[5])
            .scale(4)
        ...
        model_parameters_text = (
            Text("Model Parameters*", font="Myriad Pro", font_size=24)
        ...
        def edge_point(c1, c2):
            ...
            ul, ur, dl, dr = (
                c1.get_critical_point(UL),
                c1.get_critical_point(UR),
                c1.get_critical_point(DL),
                c1.get_critical_point(DR),
            )
...
class P27_29(Scene):
    def construct(self):
        ...
        self.play(
            self.camera.frame.animate.set_width(16).move_to([3.9, -1.15, 0]), run_time=2
        )
